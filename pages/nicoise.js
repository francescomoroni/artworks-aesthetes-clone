...
export default function Lezardrieux() {
  ...
  const linkMarketplace = require("../components/link_nicoise.js");
  ...
  useEffect(() => {
    ...
    splitImageInNParts("/nicosie.jpg");
  }, []);
    ...
    <div className="flex flex-col justify-between min-h-screen">
      ...
      <div className="mt-4 bg-white ">
        ...
        <div className="text-center sm:py-4 sm:space-y-4">
          ...
          <p className="text-lg sm:text-5xl font-Caslon">
            Niçoise en costume local
          </p>
        </div>
        ...
        <div className="items-center justify-around pt-2 mx-4 sm:flex sm:justify-center sm:pt-6">
          ...
          <img
            ...
            src="/nicosie.jpg"
            alt="Niçoise en costume local, Berthe Morisot"
            ref={imageRef}
          />
              ...
              <tr key={i}>
                {row.map((chunck, j) => (
                  <td
                    key={j + 1 + i * 37}
                    id={j + 1 + i * 37}
                    onClick={() => handleSelectedIndex(j + 1 + i * 37)}
                    className={`sm:p-0.5 hover:scale-[1.8] hover:cursor-pointer ${
                      insertedIndex === j + 1 + i * 37 ? "scale-[2] " : ""
                    } `}
                  >
                    <img key={j} src={chunck} width={30} alt="piece" />
                  </td>
                ))}
              </tr>
            ))}
